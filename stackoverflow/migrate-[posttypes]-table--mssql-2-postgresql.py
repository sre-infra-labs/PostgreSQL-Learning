...
sql_query = "SELECT Id, Type FROM dbo.PostTypes ORDER BY Id;"
...
insert_query = """
    INSERT INTO public.posttypes (id, type)
...
for i in range(0, len(rows), BATCH_SIZE):
    ...
    values = [(row.Id, row.Type) for row in batch]
...
pg_cursor.close()
pg_conn.close()
print("✅ Data migration for posttypes completed.")
